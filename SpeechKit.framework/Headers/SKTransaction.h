...
/*!
 @enum Transaction Error Types.
 @abstract These constants define the various transaction error types.
 @constant SKTransactionErrorTypeCanceled The transaction was canceled.
 @constant SKTransactionErrorTypeConnectionError A connection error with the network occurred.
 @constant SKTransactionErrorTypeRetryError The network requests the client to retry later. The retry code returned provide more information on the situation.
 @constant SKTransactionErrorTypeQueryError The network indicated that an error occurred while processing the transaction. The error code returned provide more information on the situation.
 @constant SKTransactionErrorTypeOtherError The error is undefined.
 @constant SKTransactionErrorTypeSecurityError A connection error with the network occurred. The error is related to security settings.
 */

typedef NS_ENUM(NSUInteger, SKTransactionErrorType) {
    SKTransactionErrorTypeCanceled = 0,
    SKTransactionErrorTypeConnectionError = 1,
    SKTransactionErrorTypeRetryError = 2,
    SKTransactionErrorTypeQueryError = 3,
    SKTransactionErrorTypeOtherError = 4,
    SKTransactionErrorTypeSecurityError= 5
};

/*!
 @enum Connection Error Codes.
 @abstract These constants define the various connection error codes applicable when an error of type SKTransactionErrorTypeConnectionError or SKTransactionErrorTypeSecurityError occurs.
 @constant SKTransactionConnectionErrorTimedOutWaitingForResult Timed out while waiting for reply.
 @constant SKTransactionConnectionErrorRemoteDisconnection Remote Disconnection.
 @constant SKTransactionConnectionErrorCommandEndedUnexpectedly Command ended unexpectedly.
 @constant SKTransactionConnectionErrorCommandIdleForTooLong Command idle for too long.
 @constant SKTransactionConnectionErrorNetworkUnavailable Network unavailable.
 */

typedef NS_ENUM(NSUInteger, SKTransactionConnectionError) {
    SKTransactionConnectionErrorTimedOutWaitingForResult = 1,
    SKTransactionConnectionErrorRemoteDisconnection = 3,
    SKTransactionConnectionErrorCommandEndedUnexpectedly = 4,
    SKTransactionConnectionErrorCommandIdleForTooLong = 5,
    SKTransactionConnectionErrorNetworkUnavailable = 0x0FFF0000
};
